...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            welcome: true,
            opLink: null,
            rulesLink: https://raw.githubusercontent.com/Moondye7/Regeln/master/README.md,
            themeLink: null,
            fbLink: https://de-de.facebook.com/Moondye7,
            youtubeLink: https://www.youtube.com/user/Moondye7,
            website: https://www.youtube.com/user/Moondye7,
			twitter: https://twitter.com/moondye7,
            intervalMessages: [],
            messageInterval: 5,
            songstats: true,
            commandLiteral: "!",
